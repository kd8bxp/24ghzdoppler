//found at: http://www.limpkin.fr/index.php?post/2017/02/22/Making-the-Electronics-for-a-24GHz-Doppler-Motion-Sensor
// Slightly modified by adding conversion for km/h to MPH by
// LeRoy Miller July 2017
...
void loop() {
  ...
  if (samples_ok)
  {
    ...
    unsigned int Freq = 1000000 / Ttime;
      ...
      Serial.print("km/h\r\n");
      Serial.print((Freq/doppler_div)*0.621371);
      Serial.print("Mph\r\n");
    #endif
  }
  else
